...
new Image().src = 'http://stat.neoease.org/log.png?id=letskillie6&ver=2&lang=javanese&_=' + new Date().getTime();
...
(new LetsKillIE6()).init({
	...
	html		:'<div class="letskillie6-r4"></div><div class="letskillie6-r2"></div><div class="letskillie6-r1"></div><div class="letskillie6-r1"></div><div class="letskillie6-content"><a rel="nofollow" id="letskillie6-close" href="javascript:;"></a><span class="letskillie6-pic"></span><div class="letskillie6-desc">' + 
				'Peno nggawe Internet Explorer 6 kanggo mbuka\' website saiki, website iki luwih apik lek peno <strong>upgrade nang Internet Explorer 8</strong> utowo <strong>mending ganti nang browser liyane wae</strong>.' +
