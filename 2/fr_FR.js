...
new Image().src = 'http://stat.neoease.org/log.png?id=letskillie6&ver=2&lang=fr_FR&_=' + new Date().getTime();
...
(new LetsKillIE6()).init({
	...
	html		:'<div class="letskillie6-r4"></div><div class="letskillie6-r2"></div><div class="letskillie6-r1"></div><div class="letskillie6-r1"></div><div class="letskillie6-content"><a rel="nofollow" id="letskillie6-close" href="javascript:;"></a><span class="letskillie6-pic"></span><div class="letskillie6-desc">' + 
				'Vous utilisez actuellement Internet Explorer 6 pour visiter ces pages web, ce site fonctionnerait mieux si vous <strong>passiez à Internet Explorer 8</strong> ou <strong>changiez de navigateur</strong>.' +
