...
new Image().src = 'http://stat.neoease.org/log.png?id=letskillie6&ver=2&lang=th&_=' + new Date().getTime();
...
(new LetsKillIE6()).init({
	...
	html		:'<div class="letskillie6-r4"></div><div class="letskillie6-r2"></div><div class="letskillie6-r1"></div><div class="letskillie6-r1"></div><div class="letskillie6-content"><a rel="nofollow" id="letskillie6-close" href="javascript:;"></a><span class="letskillie6-pic"></span><div class="letskillie6-desc">' + 
				'ตอนนี้คุณกำลังใช้ Internet Explorer 6 ในการเยี่ยมชมเว็บไซต์ เว็บไซต์แห่งนี้ทำงานได้ดีถ้าคุณทำการ<strong>อัพเกรดไปเป็น Internet Explorer 8</strong> หรือ<strong>เปลี่ยนไปใช้เบราเซอร์ตัวอื่นแทน</strong>.' +
