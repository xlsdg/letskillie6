...
new Image().src = 'http://stat.neoease.org/log.png?id=letskillie6&ver=2&lang=nl_NL&_=' + new Date().getTime();
...
(new LetsKillIE6()).init({
	...
	html		:'<div class="letskillie6-r4"></div><div class="letskillie6-r2"></div><div class="letskillie6-r1"></div><div class="letskillie6-r1"></div><div class="letskillie6-content"><a rel="nofollow" id="letskillie6-close" href="javascript:;"></a><span class="letskillie6-pic"></span><div class="letskillie6-desc">' + 
				'Momenteel gebruikt u Internet Explorer 6 als webbrowser, deze website zal beter functioneren als u <strong>upgrade naar Internet Explorer 8</strong> of <strong>overstapt op een andere browser</strong>.' +
