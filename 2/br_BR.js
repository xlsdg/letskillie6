...
new Image().src = 'http://stat.neoease.org/log.png?id=letskillie6&ver=2&lang=br_BR&_=' + new Date().getTime();
...
(new LetsKillIE6()).init({
	...
	html		:'<div class="letskillie6-r4"></div><div class="letskillie6-r2"></div><div class="letskillie6-r1"></div><div class="letskillie6-r1"></div><div class="letskillie6-content"><a rel="nofollow" id="letskillie6-close" href="javascript:;"></a><span class="letskillie6-pic"></span><div class="letskillie6-desc">' + 
				'Voc&ecirc; esta usando o Internet Explorer 6 neste momento, este site funcionar&aacute; melhor se voc&ecirc; <strong>atualizar para o Internet Explorer 8</strong> ou <strong>trocar por outro navegador</strong>.' +
