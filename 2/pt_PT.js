...
new Image().src = 'http://stat.neoease.org/log.png?id=letskillie6&ver=2&lang=pt_PT&_=' + new Date().getTime();
...
(new LetsKillIE6()).init({
	...
	html		:'<div class="letskillie6-r4"></div><div class="letskillie6-r2"></div><div class="letskillie6-r1"></div><div class="letskillie6-r1"></div><div class="letskillie6-content"><a rel="nofollow" id="letskillie6-close" href="javascript:;"></a><span class="letskillie6-pic"></span><div class="letskillie6-desc">' + 
				'Está a usar o Internet Explorer 6 para navegar pela Internet agora mesmo, o nosso WebSite irá trabalhar melhor se <strong>actualizar para o Internet Explorer 8</strong> ou <strong>mude para outro browser</strong>.' +
