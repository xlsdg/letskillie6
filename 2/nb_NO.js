...
new Image().src = 'http://stat.neoease.org/log.png?id=letskillie6&ver=2&lang=nb_NO&_=' + new Date().getTime();
...
(new LetsKillIE6()).init({
	...
	html		:'<div class="letskillie6-r4"></div><div class="letskillie6-r2"></div><div class="letskillie6-r1"></div><div class="letskillie6-r1"></div><div class="letskillie6-content"><a rel="nofollow" id="letskillie6-close" href="javascript:;"></a><span class="letskillie6-pic"></span><div class="letskillie6-desc">' + 
				'Du bruker Internet Explorer 6 som nettleser på internett i øyeblikket, ditt nettsted/blogg vil fungere bedre dersom du <strong>oppgraderer til Internet Explorer 8</strong> eller <strong>velger en annen nettleser</strong>.' +
