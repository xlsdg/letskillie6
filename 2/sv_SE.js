...
new Image().src = 'http://stat.neoease.org/log.png?id=letskillie6&ver=2&lang=sv_SE&_=' + new Date().getTime();
...
(new LetsKillIE6()).init({
	...
	html		:'<div class="letskillie6-r4"></div><div class="letskillie6-r2"></div><div class="letskillie6-r1"></div><div class="letskillie6-r1"></div><div class="letskillie6-content"><a rel="nofollow" id="letskillie6-close" href="javascript:;"></a><span class="letskillie6-pic"></span><div class="letskillie6-desc">' + 
				'Du använder just nu Internet Explorer 6 som läsare för webben, våra webbsidor fungerar bättre om du <strong>uppdaterar till Internet Explorer 8</strong> eller <strong>byter till en annan webbläsare</strong>.' +
