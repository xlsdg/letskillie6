...
new Image().src = 'http://stat.neoease.org/log.png?id=letskillie6&ver=2&lang=de_DE&_=' + new Date().getTime();
...
(new LetsKillIE6()).init({
	...
	html		:'<div class="letskillie6-r4"></div><div class="letskillie6-r2"></div><div class="letskillie6-r1"></div><div class="letskillie6-r1"></div><div class="letskillie6-content"><a rel="nofollow" id="letskillie6-close" href="javascript:;"></a><span class="letskillie6-pic"></span><div class="letskillie6-desc">' + 
				'Sie benutzen gerade den Internet Explorer 6 um sich Internetseiten anzuschauen. Diese Internetseiten werden besser funktionieren, wenn Sie Internet Explorer 8 oder einen anderen Browser benutzen.' +
