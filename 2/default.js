...
(new LetsKillIE6()).init({
	...
	cssUrl		:'default.css',
	html		:'<div class="letskillie6-r4"></div><div class="letskillie6-r2"></div><div class="letskillie6-r1"></div><div class="letskillie6-r1"></div><div class="letskillie6-content"><a rel="nofollow" id="letskillie6-close" href="javascript:;">Close</a><span class="letskillie6-pic"></span><p>' + 
				'You\'re using Internet Explorer 6 to browse webpages right now, our website will work better for you if you <strong>upgrade to Internet Explorer 8</strong> or <strong>switch to another browser</strong>.' +
