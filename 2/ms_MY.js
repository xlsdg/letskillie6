...
new Image().src = 'http://stat.neoease.org/log.png?id=letskillie6&ver=2&lang=ms_MY&_=' + new Date().getTime();
...
(new LetsKillIE6()).init({
	...
	html		:'<div class="letskillie6-r4"></div><div class="letskillie6-r2"></div><div class="letskillie6-r1"></div><div class="letskillie6-r1"></div><div class="letskillie6-content"><a rel="nofollow" id="letskillie6-close" href="javascript:;"></a><span class="letskillie6-pic"></span><div class="letskillie6-desc">' + 
				'Anda sedang menggunakan pelayar web Internet Explorer 6, laman web ini beroperasi dengan lebih baik sekiranya anda <strong>naik taraf kepada Internet Explorer 8</strong> atau <strong>menukar terus kepada pelayar web lain</strong>.' +
