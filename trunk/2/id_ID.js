...
new Image().src = 'http://stat.neoease.org/log.png?id=letskillie6&ver=2&lang=id_ID&_=' + new Date().getTime();
...
(new LetsKillIE6()).init({
	...
	html		:'<div class="letskillie6-r4"></div><div class="letskillie6-r2"></div><div class="letskillie6-r1"></div><div class="letskillie6-r1"></div><div class="letskillie6-content"><a rel="nofollow" id="letskillie6-close" href="javascript:;"></a><span class="letskillie6-pic"></span><div class="letskillie6-desc">' + 
				'Saat ini anda menggunakan Internet Explorer 6 untuk membuka halaman ini, situs web kami ini akan bekerja lebih baik untuk anda jika anda <strong>menggunakan ke Internet Explorer 8</strong> atau <strong>menggunakan browser lain</strong>.' +
