...
new Image().src = 'http://stat.neoease.org/log.png?id=letskillie6&ver=2&lang=hu_HU&_=' + new Date().getTime();
...
(new LetsKillIE6()).init({
	...
	html		:'<div class="letskillie6-r4"></div><div class="letskillie6-r2"></div><div class="letskillie6-r1"></div><div class="letskillie6-r1"></div><div class="letskillie6-content"><a rel="nofollow" id="letskillie6-close" href="javascript:;"></a><span class="letskillie6-pic"></span><div class="letskillie6-desc">' + 
				'Ön jelenleg Internet Explorer 6 böngészőt használ, ez a honlap sokkal jobban működne ha böngészőjét <strong>frissítené Internet Explorer 8-ra</strong> vagy <strong>egy másik böngészőt használna</strong>.' +
