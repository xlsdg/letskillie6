...
new Image().src = 'http://stat.neoease.org/log.png?id=letskillie6&ver=2&lang=gr&_=' + new Date().getTime();
...
(new LetsKillIE6()).init({
	...
	html		:'<div class="letskillie6-r4"></div><div class="letskillie6-r2"></div><div class="letskillie6-r1"></div><div class="letskillie6-r1"></div><div class="letskillie6-content"><a rel="nofollow" id="letskillie6-close" href="javascript:;"></a><span class="letskillie6-pic"></span><div class="letskillie6-desc">' + 
				'Χρησιμοποιείτε τον Internet Explorer 6 για να περιηγηθείτε στο διαδίκτυο. Θα αξιοποιήσετε καλύτερα την ιστοσελίδα μας αναβαθμίζοντας σε Internet Explorer 8 ή εγκαθιστώντας κάποιον άλλον περιηγητή.' +
